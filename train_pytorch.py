...
run = neptune.init_run(
    project="okt-project-test/okt-project-test",
    api_token="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiIxMjA2MjA0OS01ZGE3LTQxZGItODM0Yi0zYzMxMjc5MzQ5MTUifQ==",
)
